...
```shell
# [Option] when the ollama server dosen't be installed, Istall ollama
$ curl -fsSL https://ollama.com/install.sh | sh
$ ollama -v

# Set the saved model path to the path I want.
$ export OLLAMA_MODELS=/data1/deepseek_models
$ echo 'export OLLAMA_MODELS=/data1/deepseek_models' >> ~/.bashrc
$ source ~/.bashrc
...
# [Option] Start ollama service if the server doesn't be started
$ ollama serve
```

```shell
# run metagpt
# please check the default(cls) function on the ./metagpt/config2.py file
# and set the 105 line as METAGPT_ROOT / "config/config_ollama.yaml" if you want to use the local deepseek-r1 
# Especially, I loaded "DeepSeek R1 Distill Llama 70B"
# if you use the other models on ollama, you have to modify the model name on the config_ollama.yaml.
$ python main.py
```
