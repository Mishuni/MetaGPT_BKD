...
from metagpt.prompts.ma_sec_prompts import CONTEXT_TEMPLATE_FOR_WRITEPRD_WITH_RPODUCT_MANAGER
...
class WritePRD(Action):
    ...
    async def _handle_new_requirement(self, req: Document) -> ActionOutput:
        ...
        context = CONTEXT_TEMPLATE_FOR_WRITEPRD_WITH_RPODUCT_MANAGER.format(requirements=req, project_name=project_name)
