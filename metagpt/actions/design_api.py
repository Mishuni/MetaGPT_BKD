...
from metagpt.prompts.ma_sec_prompts import NEW_REQ_TEMPLATE_FOR_WRITE_DESIGN_WITH_ARCHITECT
...
class WriteDesign(Action):
    ...
    async def _merge(self, prd_doc, system_design_doc):
        context = NEW_REQ_TEMPLATE_FOR_WRITE_DESIGN_WITH_ARCHITECT.format(old_design=system_design_doc.content, context=prd_doc.content)
